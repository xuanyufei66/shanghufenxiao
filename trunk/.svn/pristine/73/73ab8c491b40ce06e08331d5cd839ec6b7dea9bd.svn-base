...
//        resultBo.setResultBody(pageResponseCommBean);
        ...
        Page<RespDistributionOrderBo> distributionOrderBoList =
                orderService.orderList(respLoginPCBean, reqDistributionOrderBo);
...
//        resultBo.setResultBody(respCustomerLevelBos);
        ...
        RespLoginPCBean respLoginPCBean = getUserInfo();
        ResultBo resultBo = ResultBo.build();
        List<RespCustomerLevelBo> customerLevelBoList = orderService
...
//        resultBo.setResultBody(respAreaInfoBoList);
        ...
        RespLoginPCBean respLoginPCBean = getUserInfo();
        ResultBo resultBo = ResultBo.build();
        List<RespAreaInfoBo> areaInfoBoList = orderService.salesAreaList
                (respLoginPCBean);
...
//        resultBo.setResultBody(respDistributionBoList);
        ...
        RespLoginPCBean respLoginPCBean = getUserInfo();
        ResultBo resultBo = ResultBo.build();
        List<RespDistributionBo> distributionBoList = orderService
                .transportList(respLoginPCBean);
...
//        resultBo.setResultBody(respCustomerBoList);
        ...
        RespLoginPCBean respLoginPCBean = getUserInfo();
        ResultBo resultBo = ResultBo.build();
        List<RespCustomerBo> customerBoList = orderService.customerList
                (respLoginPCBean);
...
//        resultBo.setResultBody(respProductBoList);
        ...
        ResultBo resultBo = ResultBo.build();
        List<RespProductBo> productBoList = orderService.productList
                (transportId);
...
//        resultBo.setResultBody(respOperationLogBoList);
        ...
        ResultBo resultBo = ResultBo.build();
        List<RespOperationLogBo> operationLogBoList = orderService
                .noteList(orderId);
...
//        ResultBo resultBo = ResultBo.build();
        ...
        RespLoginPCBean respLoginPCBean = getUserInfo();
        ResultBo resultBo = ResultBo.build();
        orderService.addRemark(respLoginPCBean, orderId, content);
        return resultBo;
    }
...
//        resultBo.setResultBody(respOrderDetailsBo);
        ...
        ResultBo resultBo = ResultBo.build();
        RespOrderDetailsBo orderDetailsBo = orderService.orderDetails
                (orderId);
...
//        resultBo.setResultBody(rspPaymentRecordsBos);
        ...
        ResultBo resultBo = ResultBo.build();
        List<RspPaymentRecordsBo> paymentRecordsBoList = orderService
...
//        ResultBo resultBo = ResultBo.build();
        ...
        RespLoginPCBean respLoginPCBean = getUserInfo();
        ResultBo resultBo = ResultBo.build();
        orderService.orderReviewOrCancellation(respLoginPCBean, orderId,
...
//        ResultBo resultBo = ResultBo.build();
        ...
        RespLoginPCBean respLoginPCBean = getUserInfo();
        ResultBo resultBo = ResultBo.build();
        orderService.orderSaveOrUpdate(respLoginPCBean,

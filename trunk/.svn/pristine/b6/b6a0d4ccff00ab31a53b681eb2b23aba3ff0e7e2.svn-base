...
public class TConsumerInfoEntity {
    ...
    //客户状态 open-开启 close-禁用
    private String fIndentStatus;
    ...
    @Basic
    @Column(name = "f_indent_status", nullable = false )
    ...
    @Basic
    @Column(name = "f_indent_password", nullable = true, length = 50)

...
public interface IAppOrderService {
     ...
     * @return
     */
    String pickGoods(Long tranOrderId, Long orderId);
     ...
     * @return
     */
    TOrderEntity getOrderPublic(Long companyId, Long id);
     ...
     * @return
     */
    int updateOrder(long orderId,long companyId,BigDecimal payMoney);
     ...
     * @return
     */
    int savePaymentHistory(TPaymentHistoryEntity paymentHistoryEntity);
}

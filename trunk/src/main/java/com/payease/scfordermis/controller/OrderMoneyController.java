...
public class OrderMoneyController {
    ...
    @Autowired
    private IOrderMoneyService orderMoneyService;
    ...
    public ResultBo getMoney(HttpSession session, ReqOrderMoneyBean orderMoneyBean) {
        ...
        try {
            RespOrderMoneyTotalBean bean = orderMoneyService.getMoney(session,orderMoneyBean);
...
//        return result;
        ...
        try {
            PageResponseCommBean page =this.orderMoneyService.getList(session,orderMoneyBean);

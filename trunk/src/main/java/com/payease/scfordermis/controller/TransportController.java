...
//        ResultBo resultBo1=transportService.transportListSelect(respLoginPCBean,reqTransportBo);
        ResultBo resultBo=transportService.transportListSelect(getUserInfo(),reqTransportBo);
...
//    respLoginPCBean.setfId((long)1);
      ...
      boolean b= transportService.transportDelete(getUserInfo(),transportId,transportStatus);
...
//        transportService.transportSave(respLoginPCBean,reqTransportAddBo);
       boolean b= transportService.transportSave(getUserInfo(),reqTransportAddBo);
    ...
    public ResultBo tranportDelete(String  transportOrderDetailId){
        ResultBo resultBo = ResultBo.build();
        boolean b=transportService.deleteGoods(transportOrderDetailId);
...
//        transportService.getGoods(respLoginPCBean);
        List<RespGoodsBo> respGoodsBos=transportService.getGoods(getUserInfo());
...
//        rspGoodsBos.add(rspGoodsBo);
        resultBo.setResultBody(respGoodsBos);
    ...
    public ResultBo transportDetail(String transportOrderId){
        ResultBo resultBo =ResultBo.build();
        RespTransportDetailBo respTransportDetailBo =transportService.transportDetail(getUserInfo(),transportOrderId);
...
//
//        ResultBo resultBo = ResultBo.build();
        resultBo.setResultBody(respTransportDetailBo);
        return resultBo;
    }
    ...
    public ResultBo transportRemark(String transportId,String remarkContent){
        ResultBo resultBo = ResultBo.build();
        boolean b=transportService.transportRemarkInfoUpdate(getUserInfo(),transportId,remarkContent);
...
//        respLoginPCBean.setfId((long)1);
//        ResultBo resultBo = ResultBo.build();
        transportService.transportInfoUpdate(getUserInfo(),reqTransportInfoBo);
...
//        respLoginPCBean.setfName("yanghongfei");
//        respLoginPCBean.setfId((long)1);
         boolean b=transportService.load(getUserInfo(),transportOrderId,transportStatus);
        return resultBo;
    }

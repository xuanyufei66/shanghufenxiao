 ...
 */
@Entity
@Table(name = "t_consumer_level")
public class TConsumerLevelEntity {
    private long fId;
    ...
    @Basic
    @Column(name = "f_discount", nullable = true, length = 20)
    ...
    public boolean equals(Object o) {
        ...
        TConsumerLevelEntity that = (TConsumerLevelEntity) o;
        return fId == that.fId &&
                fCompanyId == that.fCompanyId &&
                Objects.equals(fName, that.fName) &&
                Objects.equals(fDiscount, that.fDiscount) &&
    ...
    public int hashCode() {
        ...
        return Objects.hash(fId, fName, fDiscount, fCreateTime, fUpdateTime, fOperate, fCompanyId);
    }
}
